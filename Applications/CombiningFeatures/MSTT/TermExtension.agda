...
module Applications.CombiningFeatures.MSTT.TermExtension (mt : ModeTheory) where
...
open import Applications.CombiningFeatures.Model.Modalities ? as M
  hiding (later; constantly; forever; ▻)
open import Applications.CombiningFeatures.Model.Streams.Guarded ? as M
...
open import Applications.CombiningFeatures.MSTT.Syntax.Type ?
