...
module Applications.CombiningFeatures.MSTT.TypeExtension (mt : ModeTheory) where

open import Data.List hiding (_++_)
open import Data.String
open import Relation.Binary.PropositionalEquality

open import Applications.CombiningFeatures.Model.Streams.Guarded as M hiding (GStream)
