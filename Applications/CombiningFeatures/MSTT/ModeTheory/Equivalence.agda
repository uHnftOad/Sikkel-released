...
module Applications.CombiningFeatures.MSTT.ModeTheory.Equivalence (mt : ModeTheory) where
...
open import Applications.CombiningFeatures.Model.Modalities ? as M hiding (constantly; forever; later; _⊛_)
