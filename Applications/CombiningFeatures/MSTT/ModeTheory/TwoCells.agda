...
module Applications.CombiningFeatures.MSTT.ModeTheory.TwoCells (mt : ModeTheory) where

open import Relation.Binary.PropositionalEquality

open import MSTT.TCMonad

open import Applications.CombiningFeatures.MSTT.ModeTheory.Expressions mt
open import Applications.CombiningFeatures.MSTT.ModeTheory.Equivalence mt

open import Model.CwF-Structure as M
open import Model.Modality as M hiding (𝟙; _ⓜ_; _ⓣ-vert_; _ⓣ-hor_)
open import Applications.CombiningFeatures.Model.Modalities ? as M hiding
