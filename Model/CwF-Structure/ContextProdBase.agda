...
⊚-comp-const-substʳ : (g₁ : Hom D d₁ d₂) → (g₂ : Hom D d₂ d₃) → 
...
fix-substˡ : (σ : Δ ⇒ Γ) → (c : Ob C) → Δ ⟨ c ⟩ˡ ⇒ Γ ⟨ c ⟩ˡ
